...
public interface CollectListener {
    ...
    /**
     * Callback containing the list of topic subscriptions for the node.
     * @param nodeId Id of the node being queried
     * @param topics List of topic names the node is subscribed
     */
